<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Categorías de Servicios</h2>
        <p class="text-gray-500 text-sm">Organiza los servicios por categorías</p>
    </div>
...
<div class="bg-white rounded-xl shadow-sm p-12 text-center">
    ...
    <h3 class="text-xl font-semibold text-gray-700">No hay categorías</h3>
    <p class="text-gray-500 mt-2">Comienza agregando la primera categoría</p>
</div>
<?php endif; ?>
